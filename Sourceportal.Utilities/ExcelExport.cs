...
namespace Sourceportal.Utilities
{
    ...
    {
        private static readonly string fullRelativePath = "~/Documents/Export/";
        public static bool CreateExcelDocument<T>(List<T> list, ref string xlsxFilePath, string fileName, ref string errorMsg)
        {
            DataSet ds = new DataSet();
            ds.Tables.Add(ListToDataTable(list));

            //Use default documents folder if no path is supplied
            if (string.IsNullOrEmpty(xlsxFilePath))
                xlsxFilePath = fullRelativePath;

            //Add filename to path
            xlsxFilePath += fileName;
            string fullPath = System.Web.Hosting.HostingEnvironment.MapPath(xlsxFilePath);

            //Return relative path only
            return CreateExcelDocument(ds, fullPath, ref errorMsg);
        }
        ...
        public static bool CreateExcelDocument(DataTable dt, ref string xlsxFilePath, string fileName, ref string errorMsg)
        {
            DataSet ds = new DataSet();
            ds.Tables.Add(dt);
            ...
            bool result = CreateExcelDocument(ds, xlsxFilePath, ref errorMsg);
            ds.Tables.Remove(dt);
            return result;
        }
        #endregion
        ...
        public static bool CreateExcelDocument(DataSet ds, string excelFilename, ref string errorMsg)
        {
            try
            {
