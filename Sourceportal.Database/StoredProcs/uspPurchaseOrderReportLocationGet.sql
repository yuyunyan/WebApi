/* =============================================
   ...
   Description:	Gets locations from Locations tbl using PurchaseOrderID
   Usage: EXEC  @PurchaseOrderID = 100009, @VersionID = 2, @LocationTypeID = 2
   SELECT *FROM lkpLocationTypes
   Revision History:
		2018.06.04	AR	Initial Deployment
		2018.07.13	NA	Changed to WarehouseID for PO location
   Return Codes:
   ============================================= */
CREATE PROCEDURE [dbo].[uspPurchaseOrderReportLocationGet]
(
...
BEGIN 
	...
	BEGIN
		...
		INNER JOIN Warehouses w ON p.ToWarehouseID = w.WarehouseID
