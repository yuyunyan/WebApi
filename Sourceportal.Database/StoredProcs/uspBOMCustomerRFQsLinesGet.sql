/* =============================================
   ...
   Description:		Retrieves Customer RFQs lines
   Usage:			EXEC uspBOMCustomerRFQsLinesGet @SearchID = 1286 
					EXEC uspBOMCustomerRFQsLinesGet @SearchID = 45 
   Revision History:
		2017.10.25	AR	Added BOM Columns
   ============================================= */
CREATE PROCEDURE [dbo].[uspBOMCustomerRFQsLinesGet]
(
	@SearchID INT,
	@RowOffset INT = 0,
	@RowLimit INT = 50,
